    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="dropdown user user-menu" style="margin-top: 8px;">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                {{-- <img src="{{ asset('public/assets/img/user.png') }}" class="user-image" alt="User Image"> --}}
            ...
            <ul class="dropdown-menu">
                ...
                <li class="user-header">
                    {{-- <img src="{{url('sources/storage/app/FILE_PHOTOPROFILE/aa.jpg')}}" style="width: 100px; height: 100px; object-fit: cover; border: 2px solid #adb5bd;" class="img-circle" alt="User Image"> --}}
                    <img src="{{ asset('public/assets/img/user.png') }}" style="width: 100px; height: 100px; object-fit: cover; border: 2px solid #adb5bd;" class="img-circle" alt="User Image">
