...
<head>
    ...
    <!-- BS Stepper -->
    <link rel="stylesheet" href="{{ asset('public/assets/admin/plugins/bs-stepper/css/bs-stepper.min.css')}}">
    @yield('link_href')
</head>
<body class="hold-transition sidebar-mini layout-navbar-fixed">
    <div class="wrapper">
        ...
        @include('user::layouts/halamanbelakang/sidebar')
        @include('user::layouts/halamanbelakang/navbar')
        ...
        @include('user::layouts/halamanbelakang/footer')
