...
<style>
    ...
    .line {
        ...
        margin: 0;
        position: relative;
        top: -25px; /* posisikan di tengah lingkaran */
    }
    ...
    .step p {
        ...
        font-size: 14px;
        text-align: center;
        min-height: 32px; /* supaya semua step punya tinggi teks yang sama */
        display: flex;
        align-items: center;
        justify-content: center;
        white-space: nowrap;
                    ...
                    @if($batch)
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <span class="text-bold"><code>9. Jika Terjadi masalah, silahkan hubungi nomor yang sudah tertera pada halaman depan via Whatsapp </code></span><br><br>
