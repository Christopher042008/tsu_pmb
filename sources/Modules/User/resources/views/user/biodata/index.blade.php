                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('biodata.Save')}}" id="form-biodata" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div id="page-1">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" min="0" class="form-control pageku-1" name="nik" id="nik" value="{{$bio->nik}}" placeholder="Masukan NIK">
                                            <label for="nokk"><code>*</code> No. KK</label>
                                            <input type="number" min="0" class="form-control pageku-1" name="nokk" id="nokk" placeholder="Masukan No KK">
                                            <label for="nama"><code>*</code> Nama</label>
                                            <input type="text" class="form-control pageku-1" name="nama" id="nama" value="{{$bio->nama}}" placeholder="Masukan Nama Lengkap">
                                            ...
                                            <input type="text" class="form-control pageku-1" name="tempat_lahir" id="tempat_lahir" placeholder="Masukan Tempat Lahir">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" min="0" class="form-control pageku-1" name="nohp" id="nohp"  value="{{$bio->nohp}}" placeholder="Masukan No HP">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control select2 pageku-1" id="provinsi" name="provinsi">
                                                ...
                                                <option value="{{$p->idprov}}" {{$p->idprov==$bio->provinsi ? 'selected' : ''}}>{{$p->nama_provinsi}}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select class="form-control select2 pageku-1" id="kabupatenkota" name="kabupatenkota">
                                                ...
                                                <option value="{{$kb->idkab}}" {{($kb->idprov==$bio->provinsi&&$kb->idkab==$bio->kabupaten) ? 'selected' : ''}}>{{$kb->nama_kabupaten}}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select class="form-control select2 pageku-1" id="kecamatan" name="kecamatan">
                                                ...
                                                <option value="{{$kc->idkec}}">{{$kc->nama_kecamatan}}</option>
                                                @endforeach
                                            </select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="number" min="0" class="form-control pageku-1" name="rt" id="rt" placeholder="RT">
                                                </div>
                                                <div class="col-md-2">
                                                    <label for="rw"><code>*</code> RW</label>
                                                    <input type="number" min="0" class="form-control pageku-1" name="rw" id="rw" placeholder="RW">
                                                </div>
                                                <div class="col-md-8">
                                                    <label for="kodepos"><code>*</code> Kode Pos</label>
                                                    <input type="number" min="0" class="form-control pageku-1" name="kodepos" id="kodepos" placeholder="Masukan Kode Pos">
                                                </div>
                                            </div>
                                            <label for="alamat_lengkap"><code>*</code> Alamat Lengkap</label>
                                            <textarea class="form-control pageku-1" name="alamat_lengkap" id="alamat_lengkap" rows="2" placeholder="Masukan Alamat Lengkap"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div id="page-2" style="display: none;">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control pageku-2" name="nama_ayah" id="nama_ayah" placeholder="Nama Lengkap Ayah">
                                            <label for="tempat_lahir_ayah"><code>*</code> Tempat Lahir</label>
                                            <input type="text" class="form-control pageku-2" name="tempat_lahir_ayah" id="tempat_lahir_ayah" placeholder="Tempat Lahir Ayah">
                                            <label for="tgl_lahir_ayah"><code>*</code> Tanggal Lahir</label>
                                            <input type="date" class="form-control pageku-2" name="tgl_lahir_ayah" id="tgl_lahir_ayah">
                                            ...
                                            <input type="number" min="0" class="form-control pageku-2" name="nohp_ayah" id="nohp_ayah" placeholder="No HP Ayah">
                                            <label for="pekerjaan_ayah"><code>*</code> Pekerjaan</label>
                                            <input type="text" class="form-control pageku-2" name="pekerjaan_ayah" id="pekerjaan_ayah" placeholder="Pekerjaan Ayah">
                                            <label for="penghasilan_ayah"><code>*</code> Penghasilan</label>
                                            <input type="number" min="0" class="form-control pageku-2" name="penghasilan_ayah" id="penghasilan_ayah" placeholder="Penghasilan">
                                            <label for="alamat_ayah"><code>*</code> Alamat</label>
                                            <textarea class="form-control pageku-2" name="alamat_ayah" id="alamat_ayah" rows="2" placeholder="Masukan Alamat Lengkap Ayah"></textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <span class="badge bg-warning text-bold" style="font-size: 18px;">Data Ibu</span><br>
                                            <label for="nama_ibu"><code>*</code> Nama Ibu</label>
                                            <input type="text" class="form-control pageku-2" name="nama_ibu" id="nama_ibu" placeholder="Nama Lengkap Ibu">
                                            <label for="tempat_lahir_ibu"><code>*</code> Tempat Lahir</label>
                                            <input type="text" class="form-control pageku-2" name="tempat_lahir_ibu" id="tempat_lahir_ibu" placeholder="Tempat Lahir Ibu">
                                            <label for="tgl_lahir_ibu"><code>*</code> Tanggal Lahir</label>
                                            <input type="date" class="form-control pageku-2" name="tgl_lahir_ibu" id="tgl_lahir_ibu">
                                            ...
                                            <input type="number" min="0" class="form-control" name="nohp_ibu" id="nohp_ibu" placeholder="No HP Ibu">
                                            <label for="pekerjaan_ibu"><code>*</code> Pekerjaan</label>
                                            <input type="text" class="form-control pageku-2" name="pekerjaan_ibu" id="pekerjaan_ibu" placeholder="Pekerjaan Ibu">
                                            <label for="penghasilan_Ibu"><code>*</code> Penghasilan</label>
                                            <input type="number" min="0" class="form-control pageku-2" name="penghasilan_Ibu" id="penghasilan_ibu" placeholder="Penghasilan">
                                            <label for="alamat_ibu"><code>*</code> Alamat</label>
                                            <textarea class="form-control pageku-2" name="alamat_ibu" id="alamat_ibu" rows="2" placeholder="Masukan Alamat Lengkap Ibu"></textarea>
                                        </div>
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="number" min="0" class="form-control pageku-2" name="jumlah_saudara" id="jumlah_saudara" placeholder="Jumlah Saudara">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label>Nama Saudara</label>
                                                    <input type="text" class="form-control" name="nama_saudara[]" id="nama_saudara_0" placeholder="Nama Saudara">
                                                </div>
                                                <div class="col-md-3">
                                                    <label>Pekerjaan Saudara</label>
                                                    <input type="text" class="form-control" name="pekerjaan_saudara[]" id="pekerjaan_saudara_0" placeholder="Pekerjaan Saudara">
                                                </div>
                                                <div class="col-md-2">
                                                    <label>Status</label>
                                ...
                                <div id="page-3" style="display: none;">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="nama_sekolah" id="nama_sekolah pageku-3" class="form-control" placeholder="Nama Sekolah">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" min="0" name="npsn" id="npsn" class="form-control pageku-3" placeholder="NPSN">
                                            <label for="nisn"><code>*</code> NISN</label>
                                            <input type="number" min="0" name="nisn" id="nisn" class="form-control pageku-3" placeholder="NPSN">
                                            ...
                                            <input type="number" min="0" name="nilai_akhir" id="nilai_akhir" class="form-control pageku-3" placeholder="Nilai Akhir">
                                        </div>
        ...
        $(function() {
                ...
                $('#provinsi').change(function (e) {
                    ...
                    $.ajax({
                        ...
                        beforeSend: function(response) {
                            $('#loading').show()
                            $('#kabupatenkota').empty().html('<option value="" selected disabled>-- Pilih Kabupaten/Kota --</option>')
                            $('#kecamatan').empty().html('<option value="" selected disabled>-- Pilih Kecamatan --</option>')
                            $('#kelurahan').empty().html('<option value="" selected disabled>-- Pilih Desa/Kelurahan --</option>')
                        },
                        ...
                        success: function(data) {
                            ...
                            if (data.hasil == 0) {
                                ...
                                for (i = 0; i < data.kecamatan.length; i++) {
                                    dis1 += '<option value="' + data.kecamatan[i].idkec + '">'+ data.kecamatan[i].nama_kecamatan + '</option>'
                                }
            ...
            function changeKelurahan()
            {
                $('#kecamatan').change(function (e) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: '{!! url('Biodata/ChangeKelurahan') !!}'+'/'+provinsi+'/'+kabupaten+'/'+kecamatan,
                        dataType: "JSON",
                        beforeSend: function(response) {
                            $('#loading').show()
                            $('#kelurahan').empty().html('<option value="" selected disabled>-- Pilih Desa/Kelurahan --</option>')
                        ...
                        success: function(data) {
                            ...
                            if (data.hasil == 0) {
                                ...
                                for (i = 0; i < data.kelurahan.length; i++) {
                                    dis1 += '<option value="' + data.kelurahan[i].idkel + '">'+ data.kelurahan[i].nama_kelurahan + '</option>'
                                }
