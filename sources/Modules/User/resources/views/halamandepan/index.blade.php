                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-7" data-aos="zoom-out" data-aos-delay="100">
                            <div class="hero-content">
                                ...
                                <div>
                                    <a href="{{route('register')}}" class="btn btn-warning btn-lg text-bold">Daftar Sekarang</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row mb-5">
                    <div class="col-lg-6 pe-lg-5" data-aos="fade-right" data-aos-delay="200">
                        ...
                        <div class="d-flex align-items-center mt-4 signature-block">
                            <img src="{{ asset('public/assets/user/img/misc/signature-1.webp') }}"
                                alt="Principal's Signature" width="120">
                            <div class="ms-3">
                ...
                <div class="testimonial-masonry">
                        ...
                        <div class="testimonial-content">
                            ...
                            <div class="client-info">
                                <div class="client-image">
                                    <img src="{{ asset('public/assets/user/img/person/person-f-7.webp') }}"
                                        alt="Client">
                                </div>
                    ...
                    <div class="testimonial-item highlight" data-aos="fade-up" data-aos-delay="100">
                        <div class="testimonial-content">
                            ...
                            <div class="client-info">
                                <div class="client-image">
                                    <img src="{{ asset('public/assets/user/img/person/person-m-7.webp') }}"
                                        alt="Client">
                                </div>
                                <div class="client-details">
                                    <h3>Daniel Morgan</h3>
                    ...
                    <div class="testimonial-item" data-aos="fade-up" data-aos-delay="200">
                        <div class="testimonial-content">
                            ...
                            <div class="client-info">
                                <div class="client-image">
                                    <img src="{{ asset('public/assets/user/img/person/person-f-8.webp') }}"
                                        alt="Client">
                                </div>
                                <div class="client-details">
                                    <h3>Emma Thompson</h3>
                    ...
                    <div class="testimonial-item" data-aos="fade-up" data-aos-delay="300">
                        <div class="testimonial-content">
                            ...
                            <div class="client-info">
                                <div class="client-image">
                                    <img src="{{ asset('public/assets/user/img/person/person-m-8.webp') }}"
                                        alt="Client">
                                </div>
                                <div class="client-details">
                    ...
                    <div class="testimonial-item highlight" data-aos="fade-up" data-aos-delay="400">
                        <div class="testimonial-content">
                            ...
                            <div class="client-info">
                                <div class="client-image">
                                    <img src="{{ asset('public/assets/user/img/person/person-f-9.webp') }}"
                                        alt="Client">
                                </div>
                                <div class="client-details">
                                    <h3>Olivia Carter</h3>
                    ...
                    <div class="testimonial-item" data-aos="fade-up" data-aos-delay="500">
                        <div class="testimonial-content">
                            ...
                            <div class="client-info">
                                <div class="client-image">
                                    <img src="{{ asset('public/assets/user/img/person/person-m-13.webp') }}"
                                        alt="Client">
                                </div>
                                <div class="client-details">
                                    <h3>Nathan Brooks</h3>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <article>
                            ...
                            <div class="post-img">
                                <img src="{{ asset('public/assets/user/img/blog/blog-post-1.webp') }}" alt=""
                                    class="img-fluid">
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('public/assets/user/img/person/person-f-12.webp') }}" alt=""
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <article>
                            ...
                            <div class="post-img">
                                <img src="{{ asset('public/assets/user/img/blog/blog-post-2.webp') }}" alt=""
                                    class="img-fluid">
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('public/assets/user/img/person/person-f-13.webp') }}" alt=""
                                    class="img-fluid post-author-img flex-shrink-0">
                                <div class="post-meta">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <article>
                            ...
                            <div class="post-img">
                                <img src="{{ asset('public/assets/user/img/blog/blog-post-3.webp') }}" alt=""
                                    class="img-fluid">
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="{{ asset('public/assets/user/img/person/person-m-10.webp') }}" alt=""
                                    class="img-fluid post-author-img flex-shrink-0">
                                <div class="post-meta">
