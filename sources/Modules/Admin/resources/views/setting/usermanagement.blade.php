                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h5 class="m-0">{{ $menu }}
                                <button type="button" id="btn-add" class="btn btn-success btn-sm float-right">Add User</button>
                            </h5>
                        </div>
                        <div class="card-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.show.saveUser') }}" method="post" id="form-user">
                        @csrf
        ...
        $(function() {
            ...
            function loadTablePegawai() {
                let otable = $('#example2').DataTable({
                    ...
                    order: [],
                    ajax: {
                        url: '{!! route('admin.show.tabelPegawai') !!}',
                        type: 'GET',
                    },
                    columns: [{
                            data: 'DT_RowIndex',
            ...
            function findUser() {
                $('#nik').select2({
                    ...
                    ajax: {
                        url: '{{ route('admin.show.finduser') }}', // Buat route ini nanti
                        dataType: 'json',
                        delay: 250,
            ...
            function EditUser() {
                ...
                $(document).off('click', '.btn_edit').on('click', '.btn_edit', function (e) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: '{!! url('admin/Tools/detailuser') !!}' + '/' + params,
                        dataType: "JSON",
                ...
                $(document).off('click', '.btn_delete').on('click', '.btn_delete', function (e) {
                    ...
                    Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    type: "GET",
                                    url: '{!! url('admin/Tools/deleteuser') !!}' + '/' + params,
                                    dataType: "JSON",
                                    beforeSend: function(response) {
                                        $('#loading').show()
                                    },
