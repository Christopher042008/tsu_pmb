...
<head>
    ...
    <title>Notification from {{ session('appname') }}</title>
    <style>
        /* -------------------------------------
            GLOBAL RESETS
        ------------------------------------- */
                                    ...
                                    <tr>
                                        <td>
                                            <center><b>Tiga Serangkai University</b><br>Welcome to
                                                {{ strtoupper(session('appname')) == null ? 'PMB Admin PMB TSU' : strtoupper(session('appname')) }}
                                            </center>
                                        </td><br>
                                    </tr>
                                    <tr>
                                                                            ...
                                                                            <div class="container">
                                                                                @if ($jenis == 'Reset Password')
                                                                                    ...
                                                                                    <p style="font-size: 11pt">Jika Anda tidak merasa melakukan permintaan ini, abaikan saja email ini dan tidak ada perubahan yang akan dilakukan.
                                                                                        <a href="{{ $datalist[3] }}">Klik Disini Untuk Login PMB</a>.
                                                                                @endif
